      ...
      <Card className="w-full max-w-md shadow-lg">
        <CardHeader>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <CardDescription>Sensor Monitoring & Alert Dashboard</CardDescription>
            </div>
          </div>
        </CardHeader>
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-3">
            <div className="text-sm font-medium text-muted-foreground">Demo Users (Click to Login)</div>
            <div className="space-y-2">
              {testEmails.map(testEmail => (
                ...
                >
                  ...
                  <Badge variant={testEmail.includes('supervisor') ? 'destructive' : 'secondary'}>
                    {testEmail.includes('supervisor') ? 'Supervisor' : 'Operator'}
                  </Badge>
                </button>
              ))}
            </div>
          ...
          <div className="text-xs text-muted-foreground space-y-2 rounded-lg bg-muted p-3">
            <p>
              <strong>Demo Mode:</strong> No password required. Email-based auth for demo purposes.
            </p>
            <p>
              <strong>Note:</strong> Run seed script to populate test users in database.
            </p>
          </div>
        </CardContent>
      </Card>
