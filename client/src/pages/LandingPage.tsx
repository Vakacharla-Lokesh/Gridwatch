    ...
    <div className="min-h-screen bg-gradient-to-b from-background via-background to-muted">
      ...
      <section className="container mx-auto px-4 py-20 text-center space-y-6">
        <div className="space-y-4">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Enterprise-grade platform for real-time sensor monitoring with intelligent anomaly
            detection, automated alerting, and multi-tenant zone management.
          </p>
        </div>
      ...
      <section className="container mx-auto px-4 py-20">
        <div className="text-center mb-12">
          ...
          <p className="text-muted-foreground">Everything you need to monitor sensors at scale</p>
        </div>
      ...
      <section className="container mx-auto px-4 py-20 text-center space-y-8">
        <div>
          ...
          <p className="text-muted-foreground mb-8">Production-ready architecture</p>
        </div>
