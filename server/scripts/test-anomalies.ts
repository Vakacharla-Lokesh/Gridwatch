...
async function testAnomalyDetection() {
  ...
  console.log(
    `⚠️  Note: Anomaly detection should already be seeded with rules\n`,
  );
  ...
  try {
    ...
    console.log("✅ Summary:");
    console.log("  • Normal readings accepted without anomalies ✓");
    console.log("  • Threshold anomalies detected and alerts created ✓");
    console.log("  • Rate-of-change anomalies detected ✓");
